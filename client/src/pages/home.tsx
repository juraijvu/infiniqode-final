...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-3 relative" ref={statsRef as any}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
            ...
            <div className="stat-item depth-card beam-border p-8 text-center group" data-testid="stat-satisfaction">
              <div className="mb-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center mb-4">
            ...
            <div className="stat-item depth-card beam-border p-8 text-center group" data-testid="stat-experience">
              <div className="mb-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center mb-4">
            ...
            <div className="stat-item depth-card beam-border p-8 text-center group" data-testid="stat-support">
              <div className="mb-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="depth-card beam-border p-6">
      ...
      <section className="py-3 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-4" ref={featuresRef as any}>
            <div className="feature-item depth-card beam-border p-8 group">
              <div className="mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              <div key={tech.name} className="depth-card beam-border p-6 text-center group">
      ...
      <section className="py-3 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-4" ref={methodologyRef as any}>
            <div className="methodology-step depth-card beam-border p-10 group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-4">
            ...
            <div className="relative">
              <div className="depth-card beam-border p-8">
                <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
            <div className="depth-card beam-border p-8 text-center group">
      ...
      <section className="py-3 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-4">
            <div className="depth-card beam-border p-10 group">
              <div className="mb-6">
                <div className="flex items-center space-x-3 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={industry.title} className="depth-card beam-border p-8 group">
                <div className="mb-6">
      ...
      <section className="py-3 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-4">
            <div className="depth-card beam-border p-8 group">
              <div className="mb-6">
      ...
      <section className="py-3 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="depth-card beam-border p-20 text-center relative overflow-hidden">
